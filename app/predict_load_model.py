...
# ════════════════════════════════════════════════════════════════════════════
# CLASS TRENDS ENDPOINTS — from main.py
# ════════════════════════════════════════════════════════════════════════════

@app.get("/class_trends", response_class=JSONResponse, tags=["Class Trends"])
def get_data_api():
    data = get_data()
    return JSONResponse(content=data.to_dict(orient="records"))


@app.get("/prevision/class_trends", response_class=JSONResponse, tags=["Class Trends"])
...
@app.get("/class_trends_dashboard", response_class=HTMLResponse, tags=["Class Trends"])
